...
public class ChatsWargaAdapter extends RecyclerView.Adapter<ChatsWargaAdapter.MyHolder> {

    private Context context;
    private List<ModelUser> userList;
    private String myUserId;

    public ChatsWargaAdapter(Context context, List<ModelUser> userList, String myUserId) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ChatsWargaAdapter.MyHolder(view);
    }
