...
public class KeluargaDetailActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Detail Keluarga");
        //enable back button in actionbar
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);

        noRumah = findViewById(R.id.tv_norumah_keluarga);
        noKK = findViewById(R.id.tv_no_kk_keluarga);
        namaKK = findViewById(R.id.tv_nama_kk_keluarga);
        nik1 = findViewById(R.id.tv_nik1_keluarga);
        jenisKelamin1 = findViewById(R.id.tv_jeniskelamin1_keluarga);
        tempatLahir1 = findViewById(R.id.tv_tempatlahir1_keluarga);
        tanggalLahir1 = findViewById(R.id.tv_tanggallahir1_keluarga);
        agama1 = findViewById(R.id.tv_agama1_keluarga);

        namaIstri = findViewById(R.id.tv_nama_istri_keluarga);
        nik2 = findViewById(R.id.tv_nik2_keluarga);
        statusHubungan2 = findViewById(R.id.tv_statushubungan2_keluarga);
        jenisKelamin2 = findViewById(R.id.tv_jeniskelamin2_keluarga);
        tempatLahir2 = findViewById(R.id.tv_tempatlahir2_keluarga);
        tanggalLahir2 = findViewById(R.id.tv_tanggallahir2_keluarga);
        agama2 = findViewById(R.id.tv_agama2_keluarga);
        ...
        mImageIv = findViewById(R.id.iv_ImageView_keluarga);

        btnUbah = findViewById(R.id.btn_ubah_keluarga);
        btnHapus = findViewById(R.id.btn_hapus_keluarga);
    ...
    private void updateKeluarga() {
        Intent i = new Intent(KeluargaDetailActivity.this, UpdateKeluargaActivity.class);
        i.putExtra("gKeluargaId", gKeluargaId);
        i.putExtra("gImageKK", gImageKK);
        i.putExtra("gNoRumah", gNoRumah);
        i.putExtra("gNoKK", gNoKK);

        i.putExtra("gNamaKK", gNamaKK);
        i.putExtra("gNik1", gNik1);
        i.putExtra("gJenisKelamin1", gJenisKelamin1);
        i.putExtra("gTempatLahir1", gTempatLahir1);
        i.putExtra("gtglLahir1", gtglLahir1);
        i.putExtra("gAgama1", gAgama1);

        i.putExtra("gNamaIstri", gNamaIstri);
        i.putExtra("gNik2", gNik2);
        i.putExtra("gStatusHubungan2", gStatusHubungan2);
        i.putExtra("gJenisKelamin2", gJenisKelamin2);

        i.putExtra("gTempatLahir2", gTempatLahir2);
        i.putExtra("gtglLahir2", gtglLahir2);
        i.putExtra("gAgama2", gAgama2);

        startActivity(i);

//                UpdateKeluargaDialog updateKeluargaDialog = new UpdateKeluargaDialog();
//                //open layout dialog
//                updateKeluargaDialog.show(getSupportFragmentManager(), "update keluarga dialog");
    }
...
//        mImageIv.setImageBitmap(bitmap);
    ...
    private void hapusDataKeluarga() {
        ...
        if (gKeluargaId == null) {
            onSupportNavigateUp();
            Toast.makeText(KeluargaDetailActivity.this, "Silahkan Ulangi", Toast.LENGTH_SHORT).show();
        }
        else {
            ...
            databaseKeluarga
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(KeluargaDetailActivity.this, "Data Berhasil di Hapus", Toast.LENGTH_SHORT).show();
                            onSupportNavigateUp();
                            finish();
                        }
                    });
